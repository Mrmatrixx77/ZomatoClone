...
const GetAppCenter = () => {
  ...
  return (
    <div className="container w-[100vw] bg-white flex justify-center items-center h-[100vh] md:h-[80vh] mt-[5rem]  ">
      <div className="innerContainer w-[100%] md:w-[100%] flex justify-center p-0  h-[80%] my-auto ">
        <div className="leftSide hidden md:flex justify-end  ">
          <img
            src={mobileImg}
            alt="mobileimg"
            className="w-[25rem] h-[28rem] "
          />
        </div>
          ...
          <div className="radio mt-1 mb-1">
            ...
            <div className="mt-[2rem] mb-[2rem]">
              ...
              <div className="flex flex-wrap">
                <img className="m-3 w-[10rem] cursor-pointer rounded" src={appstoreImg} alt="appstore" />
                <img
                  className="m-3 w-[10rem] cursor-pointer rounded"
                  src={playstoreImg}
                  alt="playstore"
                />
              </div>
